...
-- Add moderator role to moderator@demo.com
INSERT INTO public.user_roles (user_id, role)
SELECT 'd5009348-9829-41dc-8ffe-bda9c6894068'::uuid, 'moderator'::public.app_role
WHERE EXISTS (
  SELECT 1 FROM auth.users WHERE id = 'd5009348-9829-41dc-8ffe-bda9c6894068'::uuid
)
