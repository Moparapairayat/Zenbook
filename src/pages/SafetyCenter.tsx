...
const SafetyCenter = () => {
  ...
  const tabs = [
    { key: "blocked" as const, label: "Blocked Users", icon: UserX, count: blockedUsers.length },
    { key: "reports" as const, label: "My Reports", icon: Flag, count: myReports.length },
  ];
            ...
            {blockedUsers.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-xs text-muted-foreground/70 mt-1">
                  Blocked users can't see your listings or contact you
                </p>
              </div>
            ) : (
          ...
          <div className="space-y-2">
            {myReports.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-xs text-muted-foreground/70 mt-1">
                  Report suspicious listings to help keep the marketplace safe
                </p>
              </div>
            ) : (
