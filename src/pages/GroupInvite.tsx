        ...
        <div className="bg-card rounded-xl shadow-sm border border-border p-8 text-center">
          {status === "loading" || status === "joining" ? (
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-muted-foreground">{status === "joining" ? "Joining group..." : "Loading invite..."}</p>
            </div>
          ) : status === "success" ? (
            <div className="flex flex-col items-center gap-4">
              <CheckCircle className="w-12 h-12 text-primary" />
              <h2 className="text-xl font-bold text-foreground">You're in!</h2>
              <p className="text-muted-foreground">Welcome to <span className="font-semibold">{group?.name}</span></p>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-muted-foreground">You're already a member of <span className="font-semibold">{group?.name}</span></p>
              <button
