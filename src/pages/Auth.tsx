  ...
  const toggleInterest = (value: string) => {
    setInterests(prev =>
      prev.includes(value)
        ...
        : prev.length < 8
          ? [...prev, value]
          : (toast.error("You can select up to 8 interests"), prev)
    );
  };
        ...
        <div className="relative z-10 max-w-md w-full space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className={cn("text-base leading-relaxed max-w-sm mx-auto", isDark ? "text-white/70" : "text-slate-600")}>
              Join millions of people sharing moments, building communities, and staying connected with friends and family.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              { icon: Users, title: "Communities", desc: "Join groups that share your passions" },
              { icon: MapPin, title: "Local Events", desc: "Discover what's happening nearby" },
              { icon: Lock, title: "Privacy First", desc: "Your data stays under your control" },
              { icon: Sparkles, title: "AI Powered", desc: "Smart feeds tailored just for you" },
            ].map((feature) => (
              <div
                key={feature.title}
                className={cn(
          ...
          {/* Testimonial */}
          <div className={cn(
            "rounded-xl p-5 backdrop-blur-sm border text-center",
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            {["Share & Connect", "Marketplace", "Reels", "Watch", "Stories"].map((tag) => (
              <span
                key={tag}
                className={cn(
                  "text-xs px-3 py-1.5 rounded-full font-medium",
                  isDark ? "bg-white/10 text-white/70" : "bg-white/70 text-slate-600 shadow-sm"
                )}
              >
                {tag}
              </span>
        ...
        <div className="w-full max-w-[420px]">
          ...
          {showEmailVerification ? (
            <div className="text-center space-y-5 py-6">
              ...
              <Button
                ...
                size="lg"
              >
                <LogIn className="w-4 h-4 mr-1.5" /> Go to Login
              </Button>
            </div>
          ) :
          showForgotPassword ? (
            forgotSent ? (
              <div className="text-center space-y-4 py-4">
                ...
                <p className="text-sm text-muted-foreground">
                  We've sent a password reset link to <strong className="text-foreground">{forgotEmail}</strong>. Check your inbox and follow the link to reset your password.
                </p>
                <Button
          ...
          <div className="text-center">
            <h1 className="text-xl font-bold text-foreground">
              {isLogin ? "Welcome Back" : step === 1 ? "Create Account" : step === 2 ? "Complete Profile" : step === 3 ? "Profile Photo" : step === 4 ? "Cover Photo" : step === 5 ? "About You" : step === 6 ? "Your Interests" : "Find Friends"}
            </h1>
            <p className="text-sm text-muted-foreground mt-1">
              {isLogin
                ...
                : step === 4 ? `Step 4 of ${TOTAL_STEPS} — Add a cover photo`
                : step === 5 ? `Step 5 of ${TOTAL_STEPS} — Write a short bio`
                : step === 6 ? `Step 6 of ${TOTAL_STEPS} — Pick your interests`
                : `Step 7 of ${TOTAL_STEPS} — Connect with people`}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <>
                ...
                {import.meta.env.VITE_DEMO_MODE === 'true' && (
                  <div className="rounded-xl border border-primary/30 bg-primary/5 p-4 space-y-3">
                    ...
                    <p className="text-[11px] text-muted-foreground">Select a role to sign in instantly with a demo account.</p>
                    <div className="grid grid-cols-1 gap-2">
                      {[
                        { label: "User", email: "user@demo.com", password: "User123!", icon: "👤", desc: "Standard user" },
                        { label: "Moderator", email: "moderator@demo.com", password: "Moderator123!", icon: "🛡️", desc: "Content moderation" },
                        { label: "Admin", email: "admin@demo.com", password: "Admin123!", icon: "⚙️", desc: "Full access" },
                      ].map((account) => (
                        <button
                          key={account.email}
                          type="button"
            ...
            {!isLogin && step === 2 && (
              <>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {dateOfBirth ? format(dateOfBirth, "MMMM d, yyyy") : "Select your birthday"}
                      </Button>
                    </PopoverTrigger>
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="signup-location">Location <span className="text-muted-foreground font-normal">(optional)</span></Label>
                  <IconInput
                    id="signup-location"
                    icon={MapPin}
                    type="text"
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      if (age < 13) { toast.error("You must be at least 13 years old to sign up"); return; }
            ...
            {!isLogin && step === 4 && (
              <>
                <div className="flex flex-col items-center gap-4 py-2">
                  ...
                  >
                    {coverPreview ? (
                      <img src={coverPreview} alt="Cover photo" className="w-full h-full object-cover" />
                    ) : (
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    Recommended: 16:5 aspect ratio. You can change this later.
                  </p>
                </div>
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <Button type="button" onClick={() => setStep(5)} className="flex-1 h-11 text-[15px] font-semibold" size="lg">
                    {coverPreview ? "Continue" : "Skip"} <ChevronRight className="w-4 h-4 ml-1" />
                  </Button>
                </div>
              </>
            )}
            ...
            {!isLogin && step === 5 && (
              <>
                <div className="space-y-3 py-2">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="signup-bio">Write a short bio</Label>
                    <Textarea
                      id="signup-bio"
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <Button type="button" onClick={() => setStep(6)} className="flex-1 h-11 text-[15px] font-semibold" size="lg">
                    {bio.trim() ? "Continue" : "Skip"} <ChevronRight className="w-4 h-4 ml-1" />
                  </Button>
                </div>
              </>
            )}
            ...
            {!isLogin && step === 6 && (
              <>
                <div className="space-y-3 py-2">
                  ...
                  <p className="text-xs text-muted-foreground text-center">Select up to 8 topics you're interested in</p>
                  ...
                  {interests.length > 0 && (
                    <p className="text-xs text-primary font-medium text-center">{interests.length} selected</p>
                  )}
                </div>
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <Button type="button" onClick={() => setStep(7)} className="flex-1 h-11 text-[15px] font-semibold" size="lg">
                    {interests.length > 0 ? "Continue" : "Skip"} <ChevronRight className="w-4 h-4 ml-1" />
                  </Button>
                </div>
              </>
            )}
              ...
              <>
                <div className="space-y-4 py-2">
                  ...
                  <p className="text-sm text-muted-foreground text-center leading-relaxed">
                    You can find and connect with friends after signing up. We'll suggest people based on your interests and location.
                  </p>
                  <div className="bg-muted/50 rounded-xl p-4 space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-foreground">Search by name or email</p>
                        <p className="text-xs text-muted-foreground">Find people you know</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Based on your interests & location</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                      ...
                      <div>
                        <p className="text-sm font-medium text-foreground">Send friend requests</p>
                        <p className="text-xs text-muted-foreground">Connect and start sharing</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center">
            ...
            >
              {isLogin ? (
                <>
                  <UserPlus className="w-4 h-4 mr-1.5" /> Create new account
                </>
              ) : (
                <>
                  <LogIn className="w-4 h-4 mr-1.5" /> Already have an account? Log in
                </>
              )}
            </Button>
          </div>
