...
const Memories = () => {
  ...
  const handleShareMemory = async (post: any, yearsAgo: number) => {
    ...
    try {
      ...
      const memoryNote = `📅 On This Day, ${yearLabel} ago:\n\n${post.content}`;
      ...
      toast.success("Memory shared to your feed!");
    ...
    <AppPageShell>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Look back on posts you shared on this day over the years
              </p>
            </div>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-semibold text-foreground mb-1">No memories for this day</h3>
            <p className="text-sm text-muted-foreground max-w-sm mx-auto">
              You haven't posted anything on {format(selectedDate, "MMMM d")} in previous years. Try browsing other dates!
            </p>
          </div>
        ) : (
              ...
              <div key={yearsAgo}>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {format(subYears(selectedDate, yearsAgo), "MMMM d, yyyy")}
                  </span>
                    ...
                    <div key={post.id} className="relative">
                      ...
                      <div className="flex justify-center -mt-2 pb-2">
                        ...
                        >
                          ...
                          {sharingPostId === post.id ? "Sharing..." : "Share to Feed"}
                        </button>
                      </div>
                    </div>
                  ))}
