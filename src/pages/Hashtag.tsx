...
const Hashtag = () => {
  ...
  const {
    ...
    queryFn: async ({ pageParam }) => {
      ...
      // Search regular posts, group posts, and page posts
  ...
  const { data: relatedTags = [] } = useQuery({
    queryKey: ["hashtag-related", decodedTag],
    queryFn: async () => {
      ...
      <div className="max-w-[680px] mx-auto px-4 py-6 space-y-4">
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Explore posts, discussions, and content tagged with {hashTag}
                </p>
              </div>
              <button
                onClick={() => navigate(-1)}
        ...
        {relatedTags.length > 0 && (
          <div className="bg-card rounded-xl border border-border p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-foreground">Related Tags</h3>
            </div>
        ...
        {!isLoading && posts.length === 0 && (
          <div className="text-center py-16 bg-card rounded-xl border border-border">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Be the first to use {hashTag} in your post!
            </p>
          </div>
        )}
