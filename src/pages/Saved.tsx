            ...
            <>
              {savedPosts?.length === 0 && (
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p className="text-sm mt-1">Save posts from your feed to find them here later.</p>
                </div>
              )}
            ...
            <>
              {savedListings?.length === 0 && (
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p className="text-sm mt-1">Save marketplace listings to find them here later.</p>
                </div>
              )}
                        ...
                        <div className="h-40 bg-secondary relative">
                          ...
                          {listing.status === "sold" && (
                            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                              <span className="text-white font-bold text-sm bg-black/60 px-3 py-1 rounded-full">SOLD</span>
                            </div>
                          )}
                        </div>
                      </Link>
                      <div className="p-3">
                        <div className="flex items-start justify-between gap-2">
                          <Link to={`/marketplace/${listing.id}`} className="flex-1 min-w-0">
                            <p className="text-lg font-bold text-foreground">${Number(listing.price).toLocaleString()}</p>
