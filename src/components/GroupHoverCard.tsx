        ...
        <div className="px-3 pb-3 -mt-5">
          ...
          <div className="flex items-center gap-3 mt-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1">
              ...
              <span className="font-semibold text-foreground">{groupInfo?.memberCount ?? "—"}</span> members
            </span>
            <span>
              <span className="font-semibold text-foreground">{groupInfo?.postCount ?? "—"}</span> posts
            </span>
          </div>
