...
const UserProfileCard = ({ userId, children }: UserProfileCardProps) => {
  ...
  const displayName = profile?.display_name || (isOwnProfile ? "You" : "User");
          ...
          <div className="px-4 pb-4 -mt-8 relative">
            ...
            {isOwnProfile && (
              <div className="mt-2">
                ...
                >
                  <Eye className="w-3.5 h-3.5" /> View Your Profile
                </button>
              </div>
            )}
          </div>
      ...
      <AlertDialog open={showBlockDialog} onOpenChange={setShowBlockDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              They won't be able to see your posts or message you. If you're friends, they'll be removed from your friends list. You can unblock them anytime.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
