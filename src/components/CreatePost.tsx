...
const EMOJI_CATEGORIES = [
  ...
  {
    label: "Feelings",
    emojis: ["😊 happy","😢 sad","😡 angry","😨 scared","🥱 bored","😍 loved","🤒 sick","😴 sleepy","🥳 celebrating","🤔 thinking","😎 confident","🥺 hopeful","😤 frustrated","🫣 embarrassed","😌 relaxed"],
  },
];
...
const TEXT_BACKGROUNDS = [
  ...
  { id: "gradient-sunset", label: "Sunset", style: "bg-gradient-to-br from-orange-400 via-pink-500 to-purple-600 text-white" },
  { id: "gradient-ocean", label: "Ocean", style: "bg-gradient-to-br from-cyan-400 via-blue-500 to-indigo-600 text-white" },
  { id: "gradient-forest", label: "Forest", style: "bg-gradient-to-br from-emerald-400 via-green-500 to-teal-600 text-white" },
  { id: "gradient-night", label: "Night", style: "bg-gradient-to-br from-slate-700 via-gray-800 to-zinc-900 text-white" },
  { id: "gradient-candy", label: "Candy", style: "bg-gradient-to-br from-pink-300 via-fuchsia-400 to-violet-500 text-white" },
  { id: "gradient-fire", label: "Fire", style: "bg-gradient-to-br from-yellow-400 via-orange-500 to-red-600 text-white" },
  { id: "gradient-aurora", label: "Aurora", style: "bg-gradient-to-br from-green-300 via-cyan-400 to-blue-500 text-white" },
];

const PRIVACY_OPTIONS = [
  { id: "public", label: "Public", icon: Globe, desc: "Anyone can see this post" },
  { id: "friends", label: "Friends", icon: Users, desc: "Only your friends" },
...
const CreatePost = ({ onPostCreated, autoOpen = false }: CreatePostProps & { autoOpen?: boolean }) => {
  ...
  const handleImageSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    for (const file of selected) { if (file.size > 5 * 1024 * 1024) { toast.error(`${file.name} exceeds 5MB`); return; } }
  ...
  const handleVideoSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!file) return;
    if (file.size > MAX_VIDEO_SIZE_MB * 1024 * 1024) { toast.error(`Video exceeds ${MAX_VIDEO_SIZE_MB}MB`); return; }
      ...
      <div className="border-t border-border/50 px-2 py-1.5">
        <div className="flex items-center">
          ...
          >
            ...
            <span className="text-[13px] font-medium text-muted-foreground hidden sm:inline">Video</span>
          </button>
          ...
          >
            ...
            <span className="text-[13px] font-medium text-muted-foreground hidden sm:inline">Photo</span>
          </button>
          <div className="w-px h-5 bg-border/50" />
          <button
          ...
          >
            ...
            <span className="text-[13px] font-medium text-muted-foreground hidden sm:inline">Feeling</span>
          </button>
          <div className="w-px h-5 bg-border/50" />
          <button
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-[2px] flex items-center justify-center z-50 px-4 animate-in fade-in duration-150">
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-border/50 flex-shrink-0">
              <h2 className="text-[17px] font-bold text-foreground tracking-tight">Create Post</h2>
              ...
              <div className="px-5 pb-2 pt-2">
                ...
                {imagePreviews.length > 0 && (
                  <div className="relative mt-3 rounded-lg overflow-hidden border border-border/30 bg-muted/30 p-1.5">
                    ...
                    <p className="text-[11px] text-muted-foreground mt-1.5 text-center">{imageFiles.length}/{MAX_IMAGES} images</p>
                  </div>
                )}
            ...
            <div className="flex-shrink-0 px-5 pb-4 pt-2 space-y-2.5 border-t border-border/30">
              ...
              <div className="flex items-center justify-between border border-border/50 rounded-lg px-2 sm:px-3 py-2 gap-1">
                <span className="text-[13px] font-semibold text-foreground whitespace-nowrap hidden sm:inline">Add to your post</span>
