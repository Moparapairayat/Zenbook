      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div className="rounded-lg bg-card shadow-sm p-4">
          ...
          {stats.pendingOffers > 0 && (
            <p className="text-[10px] text-amber-500 font-medium">{stats.pendingOffers} pending</p>
          )}
        </div>
        <div className="rounded-lg bg-card shadow-sm p-4">
          <div className="flex items-center gap-2 mb-1">
          ...
          <p className="text-[10px] text-muted-foreground">{stats.acceptedOffers} deals</p>
        </div>
        <div className="rounded-lg bg-card shadow-sm p-4">
          <div className="flex items-center gap-2 mb-1">
          ...
          <p className="text-[10px] text-muted-foreground">offers/views</p>
        </div>
        <div className="rounded-lg bg-card shadow-sm p-4">
          <div className="flex items-center gap-2 mb-1">
          ...
          <p className="text-[10px] text-muted-foreground">{stats.soldCount} sold</p>
        </div>
      </div>
      ...
      {stats.chartData.some((d: any) => d.views > 0) && (
        <div className="rounded-lg bg-card shadow-sm p-4">
          <h3 className="text-sm font-semibold text-foreground mb-3 flex items-center gap-2">
            <Eye className="w-4 h-4 text-primary" /> Views (Last 7 Days)
          </h3>
              ...
              return (
                <div key={item.id} className="flex items-center gap-3 px-4 py-3">
                  ...
                  <div className="flex items-center gap-4 text-xs text-muted-foreground shrink-0">
                    ...
                    <span className="flex items-center gap-1" title="Offers">
                      <DollarSign className="w-3 h-3" /> {item.offers}
                    </span>
                    <span className="text-[10px] text-muted-foreground" title="Save rate">
                      {item.saveRate}%
                    </span>
                  </div>
                </div>
