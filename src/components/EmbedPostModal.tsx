...
const SIZE_PRESETS = [
  ...
  { label: "Medium", width: 500, height: 400 },
  { label: "Large", width: 600, height: 500 },
] as const;
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-5">
          ...
          {imageUrl && (
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Include post images in the embed</p>
              </div>
          ...
          <div className="flex items-center justify-between pt-1">
            <p className="text-xs text-muted-foreground">Only public posts can be embedded</p>
            <a
              href={embedUrl}
              target="_blank"
            ...
            >
              Open embed <ExternalLink className="w-3 h-3" />
            </a>
          </div>
        </div>
      </DialogContent>
