    ...
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-card rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-b border-border">
          <h2 className="text-lg font-bold text-foreground">Create Reel</h2>
          <button
            onClick={() => {
              stopCamera();
          ...
          {mode === "choose" && (
            <div className="space-y-3">
              ...
              >
                ...
                <p className="text-foreground font-medium">Upload a video</p>
                <p className="text-xs text-muted-foreground text-center">
                  MP4, MOV, or WebM • Max 60s • Max 100MB
                </p>
              </div>
              ...
              >
                ...
                <p className="text-foreground font-medium">Record from camera</p>
                <p className="text-xs text-muted-foreground text-center">
                  Use your device camera • Max 60 seconds
                </p>
              </div>
            </div>
          )}
          ...
          {mode === "record" && (
            <div className="space-y-3">
              ...
              <p className="text-center text-xs text-muted-foreground">
                {recording ? "Tap the square to stop" : "Tap to start recording"}
              </p>
            </div>
          )}
