    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg p-0 gap-0 rounded-xl overflow-hidden">
        <DialogHeader className="px-4 pt-4 pb-3 border-b border-border/60">
          <DialogTitle className="text-center text-lg font-semibold">Edit post</DialogTitle>
        </DialogHeader>
          ...
          <div className="p-4 space-y-4">
            ...
            {selectedFeeling && (
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-muted-foreground">Feeling <strong className="text-foreground">{selectedFeeling.label}</strong></span>
            ...
            {allImages.length > 0 && (
              <div className="relative rounded-lg overflow-hidden border border-border p-2">
                ...
                <p className="text-xs text-muted-foreground mt-1 text-center">{allImages.length}/{MAX_IMAGES} images</p>
              </div>
            )}
            ...
            <div className="border border-border rounded-xl p-3">
              <p className="text-sm font-medium text-foreground mb-2">Add to your post</p>
