              ...
              return (
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    {showReactions && (
                      <div className="absolute bottom-full left-0 mb-1 flex items-center gap-0.5 bg-card rounded-full shadow-lg border border-border px-2 py-1 z-50 animate-fade-in">
                        {REACTIONS.map((r) => (
                          <button
                            key={r.type}
