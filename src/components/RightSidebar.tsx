  ...
  return (
    <ScrollArea className="w-[350px] flex-shrink-0 h-full hidden xl:block bg-card">
      <div className="p-3">
        ...
        {sidebarAd && (
          <div className="mb-1">
            <h3 className="text-muted-foreground font-semibold text-[13px] uppercase tracking-wide px-2 mb-2">Sponsored</h3>
            <a
          ...
          <>
            ...
            <div className="mb-1">
              <div className="flex items-center justify-between px-2 mb-2">
                <h3 className="text-[13px] font-semibold text-muted-foreground uppercase tracking-wide">Suggested Pages</h3>
        ...
        {isHome && (
          <>
            ...
            <div className="mb-1">
              <div className="flex items-center justify-between px-2 mb-2">
                <h3 className="text-[13px] font-semibold text-muted-foreground uppercase tracking-wide">Suggested Groups</h3>
        ...
        {isHome && (
          <>
            ...
            <div className="mb-1">
              <div className="flex items-center justify-between px-2 mb-2">
                <h3 className="text-[13px] font-semibold text-muted-foreground uppercase tracking-wide">Upcoming Events</h3>
            ...
            {searchOpen ? (
              ...
              <>
                <h3 className="text-[13px] font-semibold text-muted-foreground uppercase tracking-wide">
                  Contacts {onlineContacts.length > 0 && <span className="text-primary">· {onlineContacts.length} online</span>}
                </h3>
          ...
          <div className="space-y-0.5">
            ...
            {!isLoading && filteredContacts.length === 0 && (
              <p className="text-xs text-muted-foreground px-2 py-3 text-center">
                {friends.length === 0 ? "No friends yet" : "No contacts found"}
              </p>
            )}
