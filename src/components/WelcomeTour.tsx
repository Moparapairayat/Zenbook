...
const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    description: "This is your home! See posts from friends, groups, and pages you follow. Create posts, share stories, and stay up-to-date with everything happening.",
    color: "text-blue-500",
  ...
  },
  {
    ...
    description: "Find and connect with people you know. Join groups based on your interests to discover communities that match your passions.",
  ...
  },
  {
    icon: MessageCircle,
    title: "Messages",
    description: "Chat with friends in real-time! Send text, photos, GIFs, voice messages, and react to messages with emojis.",
  ...
  },
  {
    icon: ShoppingBag,
    title: "Marketplace",
    description: "Buy and sell items locally. Browse listings, make offers, and connect with sellers — all within the community.",
  ...
  },
  {
    icon: Calendar,
    title: "Events",
    description: "Discover local events, RSVP to gatherings, and create your own events to bring people together.",
    color: "text-rose-500",
  ...
  },
  {
    icon: MonitorPlay,
    title: "Watch & Reels",
    description: "Enjoy videos from creators you follow. Watch longer content or swipe through short-form Reels for quick entertainment.",
    color: "text-cyan-500",
  ...
  },
  {
    ...
    description: "Start exploring, connecting, and sharing. Your profile is ready — make it uniquely yours and begin your journey!",
    color: "text-primary",
    bgGradient: "from-primary/20 to-primary/5",
  },
];
