    ...
    <>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Manage platform pages like Privacy, Terms, etc.</p>
          </div>
          ...
          <CardContent className="p-0">
            {pages.length === 0 ? (
              <div className="text-center py-12 text-muted-foreground">
                ...
                <p className="text-sm font-medium">No CMS pages yet</p>
                ...
                <TableBody>
                  {pages.map((page) => (
                    <TableRow key={page.id}>
                      ...
                      <TableCell>
                        {page.is_published ? (
                          <Badge className="bg-emerald-500/15 text-emerald-600 border-emerald-500/30">Published</Badge>
                        ) : (
      ...
      <Dialog open={!!editPage} onOpenChange={(o) => !o && closeEditor()}>
        <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>{isNew ? "Create Page" : "Edit Page"}</DialogTitle>
          </DialogHeader>
