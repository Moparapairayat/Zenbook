        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <FileText className="w-4 h-4 text-primary" /> Listing Templates
            </DialogTitle>
          </DialogHeader>
          ...
          {currentValues && (
            <div className="border-b border-border pb-3 mb-3">
              {showSave ? (
                ...
                >
                  <Plus className="w-3.5 h-3.5 mr-1.5" /> Save Current as Template
                </Button>
              )}
            </div>
          )}
          ...
          {templates && templates.length > 0 ? (
            ...
            <div className="text-center py-6">
              ...
              <p className="text-xs text-muted-foreground/70 mt-1">
                Save your listing settings to quickly reuse them
              </p>
            </div>
          )}
        </DialogContent>
