  ...
  return (
    <div className="space-y-4">
      {followedPages.length > 0 && (
        <SidebarSection title="Pages You Follow" icon={Heart}>
      ...
      {trendingPages.length > 0 && (
        <SidebarSection title="Popular Pages" icon={Sparkles}>
          <div className="space-y-1">
            {trendingPages.map((page: any) => (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-[13px] font-medium text-foreground truncate">{page.name}</p>
                  <p className="text-[11px] text-muted-foreground">{page.followers} followers</p>
                </div>
              </Link>
            ))}
          </div>
