...
const GroupsContextSidebar = () => {
  ...
  return (
    <div className="space-y-4">
      {myGroups.length > 0 && (
        <SidebarSection title="Your Groups" icon={Users}>
            ...
            {myGroups.map((group) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-muted-foreground">{group.category}</p>
                </div>
              </Link>
            ))}
          </div>
      ...
      {suggestedGroups.length > 0 && (
        <SidebarSection title="Suggested Groups" icon={Sparkles}>
          <div className="space-y-1">
            {suggestedGroups.map((group) => (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-[13px] font-medium text-foreground truncate">{group.name}</p>
                  <p className="text-[11px] text-muted-foreground line-clamp-1">{group.description || group.category}</p>
                </div>
              </Link>
            ))}
          </div>
