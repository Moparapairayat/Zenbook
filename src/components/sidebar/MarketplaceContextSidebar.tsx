...
const MarketplaceContextSidebar = () => {
  ...
  return (
    <div className="space-y-4">
      {stats && (
        <SidebarSection title="Your Activity" icon={DollarSign}>
      ...
      <SidebarSection title="Recently Added" icon={TrendingUp}>
        <div className="space-y-2">
          ...
          {trending.length === 0 && (
            <p className="text-xs text-muted-foreground text-center py-3">No listings yet</p>
          )}
        </div>
      </SidebarSection>
    </div>
