...
const emailTemplates: EmailTemplateField[] = [
  ...
  },
  {
    id: "invite_email",
    label: "Invite Email",
    description: "Sent when a user invites someone to join the platform.",
  ...
  },
  {
    id: "login_with",
    label: "Login With",
    description: "Sent when a user logs in using a social or external provider.",
  ...
  },
  {
    id: "notification",
    label: "Notification",
    description: "General notification email sent for various activity alerts.",
  ...
  },
  {
    ...
    description: "Sent when a user's payment has been declined.",
  ...
  },
  {
    ...
    description: "Sent when a user's payment has been successfully processed.",
    variables: ["{{name}}", "{{amount}}", "{{site_name}}"],
    defaultValue: `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  },
  {
    id: "unusual_login",
    label: "Unusual Login",
    description: "Sent when a login attempt is detected from an unusual location or device.",
  ...
  },
  {
    ...
    description: "Sent when a user's account has been deleted.",
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Customize the HTML templates for all system emails. Templates are persisted to the backend and consumed by transactional email functions.
        </p>
      </div>
      ...
      <div className="flex items-start gap-3 p-3 rounded-lg bg-accent/50 border border-border">
        ...
        <p className="text-xs text-muted-foreground">
          If you want to add translated texts you can use <code className="text-[10px] bg-muted px-1 py-0.5 rounded font-mono">{"{{LANG key}}"}</code> and replace <em>key</em> with the key from Languages.
        </p>
      </div>
            ...
            <CollapsibleContent>
              <CardContent className="space-y-3 pt-0">
                ...
                <p className="text-[10px] text-muted-foreground">
                  Make sure to add {template.variables.join(" , ")} in the right place.
                </p>
              </CardContent>
            </CollapsibleContent>
          </Card>
