    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Customize your website's branding, colors, and visual appearance.
          </p>
        </div>
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-base">Favicon & Logos</CardTitle>
          </div>
          <CardDescription className="text-xs">Upload your website favicon and logo images. Changes apply after saving.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <ImageUploadField
              ...
              description="Main site logo displayed in the header during light mode."
              preview={logoUrl}
            ...
            <ImageUploadField
              ...
              description="Logo variant shown when dark/night mode is active."
              preview={darkLogoUrl}
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-xs">Customize the navigation bar appearance.</CardDescription>
        </CardHeader>
        <CardContent>
          {/* Preview */}
          <div
          ...
          >
            ...
            >
              <span className="text-xs" style={{ color: headerTextColor + "80" }}>Search...</span>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <ColorField label="Background Color" value={headerBgColor} onChange={setHeaderBgColor} />
            <ColorField label="Icons/Text Color" value={headerTextColor} onChange={setHeaderTextColor} />
            <ColorField label="Search Input Background" value={headerSearchBgColor} onChange={setHeaderSearchBgColor} />
            <ColorField label="Icons Shadow Color" value={headerShadowColor} onChange={setHeaderShadowColor} />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-xs">Set the main background color of the website.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center gap-4">
            <ColorField label="Body Background Color" value={bodyBgColor} onChange={setBodyBgColor} />
            <div
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-xs">Customize button styles across the website.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            ...
            <ColorField label="Background Color" value={btnBgColor} onChange={setBtnBgColor} />
            <ColorField label="Hover Text Color" value={btnHoverTextColor} onChange={setBtnHoverTextColor} />
            <ColorField label="Hover Background Color" value={btnHoverBgColor} onChange={setBtnHoverBgColor} />
            <ColorField label="Disabled Background Color" value={btnDisabledBgColor} onChange={setBtnDisabledBgColor} />
          </div>
