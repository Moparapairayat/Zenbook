...
const AdminOnlineUsers = () => {
  ...
  const statusLabel = (status: string) => {
    ...
    if (status === "recent") return <Badge className="bg-amber-500/15 text-amber-600 border-amber-500/30 text-[10px]">Away</Badge>;
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          { label: "Away", value: recentCount, icon: Clock, color: "text-amber-500" },
